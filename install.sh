...
function install_docker {
  curl -s https://raw.githubusercontent.com/artemkovsh/DokkerUNST/main/DocUNST.sh | bash
}
...
read_wallet
line_2
echo -e "Установка Дополнительных элементов
line_1
install_tools
install_ufw
install_docker
...
# source_git
# line_1
# echo -e "Запускаем ноду"
# build_image_node
# line_1
# echo -e "Билдим фармер"
# build_image_farmer
# line_1
echo -e "Создаем docker файл"
line_1
eof_docker_compose
line_1
echo -e "Запускаем docker контейнер"
line_1
docker_compose_up
line_2
echo_info
